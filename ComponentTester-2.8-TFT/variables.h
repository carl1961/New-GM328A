 ...
 */
  ...
  /* options */
    ...
    const unsigned char IR_NEC_str[] MEM_TYPE = "NEC";
	...
	#ifdef SW_IR_RECEIVER_GRAPHICS	
      const unsigned char IR_SIRC_str[] MEM_TYPE = "SONY SIRC";
	#else
      ...
      const unsigned char IR_Kaseikyo_str[] MEM_TYPE = "Panasonic Kaseikyo";
      const unsigned char IR_Matsushita_str[] MEM_TYPE = "Matsushita";
      const unsigned char IR_Motorola_str[] MEM_TYPE = "Motorola";
      const unsigned char IR_Proton_str[] MEM_TYPE = "Proton";
      const unsigned char IR_RC5_str[] MEM_TYPE = "Philips RC-5";
      const unsigned char IR_RC6_str[] MEM_TYPE = "Philips RC-6";
      const unsigned char IR_Samsung_str[] MEM_TYPE = "Samsung";
      const unsigned char IR_Sharp_str[] MEM_TYPE = "Sharp";
      const unsigned char IR_User_str[] MEM_TYPE = "User Code: ";	
      const unsigned char IR_Data_str[] MEM_TYPE = "Data Code: ";		
	
      #if defined (SW_IR_RX_EXTRA) || defined (SW_IR_TX_EXTRA)
        const unsigned char IR_Thomson_str[] MEM_TYPE = "Thomson";
      #endif
	#else
	  const unsigned char IR_JVC_str[] MEM_TYPE = "JVC";
 ...
 */
  ...
  #ifdef SW_IR_RECEIVER_GRAPHICS	
   extern  uint8_t		 Join_Char;          /* to reduce space between characters */
  #endif
  ...
  /* options */
	...
	#ifdef SW_IR_RECEIVER_GRAPHICS	
      extern const unsigned char IR_User_str[];	
      extern const unsigned char IR_Data_str[];
    #endif		
