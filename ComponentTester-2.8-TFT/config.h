...
/*
 *  IR remote control receiver graphics
 *  - in addition to data, it displays results as graphics, simulating oscillograms 
 *  - requires color LCD graphic display and microcontroller ATmega644/1284
 *    ( define also FONT_10X16_HF or FONT_16x26_HF, 
 *      there are defined characters for "1" and "0" of the oscillogram simulation)  
 *  - uncomment to enable  (mod by boleslaw_43@mikrocontroller.net)
 */

#define SW_IR_RECEIVER_GRAPHICS
